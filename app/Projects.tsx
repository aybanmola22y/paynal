...
const projects: Project[] = [
  ...
  {
    title: 'Virtual Cake',
    description: 'Virtual Cake is an interactive web app that let a person experience digital cake. They can add candles and blow them out using their device’s microphone or earphones. ',
    image: '/assets/image/niki.png',
